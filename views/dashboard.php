...
<?php if (!($permissions['canViewLicenses'] ?? false) && !($permissions['canViewPayments'] ?? false)): ?>
        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-warning">
                <div class="card-body text-center py-5">
                    ...
                    <h3 class="text-warning mb-3">Limited Dashboard Access</h3>
                    <p class="text-muted mb-4">
                        You have limited permissions to view dashboard data. Contact your administrator to request
                        additional access.
                    </p>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Available Actions:</strong> You can view basic dashboard information only.
                    </div>
                </div>
            </div>
        </div>
...
<?php else: ?>
    ...
    <?php if ($permissions['canViewLicenses'] ?? false): ?>
        <div class="row mb-4">
    ...
    <?php if ($permissions['canViewPayments'] ?? false): ?>
        <div class="row mb-4">
            <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    $<?= number_format($stats['payments']['total_revenue'] ?? 0, 2) ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    $<?= number_format($stats['payments']['this_month_revenue'] ?? 0, 2) ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?= $stats['payments']['total_payments'] ?? 0 ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    $<?= number_format($stats['payments']['average_payment'] ?? 0, 2) ?></div>
                            </div>
                            <div class="col-auto">
                                    ...
                                    <tbody>
                                        <?php foreach ($stats['payments']['top_paying_clients'] as $client): ?>
                                            <tr>
                                                ...
                                                <td><strong
                                                        class="text-success">$<?= number_format($client['total_paid'], 2) ?></strong>
                                                </td>
                                    ...
                                    <tbody>
                                        <?php foreach ($stats['payments']['recent_payments'] as $payment): ?>
                                            <tr>
                                                ...
                                                <td><strong class="text-success">$<?= number_format($payment['amount'], 2) ?></strong>
                                                </td>
                                                <td><span class="badge bg-secondary"><?= htmlspecialchars($payment['method']) ?></span>
                                                </td>
                            ...
                            <div class="list-group list-group-flush">
                                <?php foreach ($stats['expiring_details'] as $expiring): ?>
                                    ...
                                    <div class="list-group-item list-group-item-action">
                                        ...
                                        <?php if ($permissions['canRenewLicenses'] ?? false): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="mt-2 text-center">
                                                <small class="text-muted">
                                                    ...
                                                    Renewal requires additional permissions
                                                </small>
                                            </div>
                                        <?php endif; ?>
                                    </div>
...
<!-- Renewal Modal - Only show if user has renewal permissions -->
<?php if ($permissions['canRenewLicenses'] ?? false): ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Only initialize charts if user has permissions
        <?php if ($permissions['canViewLicenses'] ?? false): ?>
        ...
        // Modal handling code - only if user has renewal permissions
        <?php if ($permissions['canRenewLicenses'] ?? false): ?>
            const renewModal = document.getElementById('renewLicenseModal');
            if (renewModal) {
                $('#renewLicenseModal').on('show.bs.modal', function (event) {
                    ...
                    // Check if user has permission before loading form
                    const hasRenewalPermission = <?= json_encode($permissions['canRenewLicenses'] ?? false) ?>;

                    if (!hasRenewalPermission) {
                        modal.find('.modal-body').html(`
                    <div class="alert alert-warning text-center">
                        <i class="fas fa-lock fa-2x mb-3"></i>
                        <h5>Permission Required</h5>
                        <p>You don't have permission to renew licenses. Contact your administrator for access.</p>
                    </div>
                `);
                        modal.find('#saveRenewalChanges').hide();
                        return;
                    }
